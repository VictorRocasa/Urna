 ...
 * @author victorPC
 */
public class frSelecionarPartidos extends javax.swing.JFrame {

    /**
     * Creates new form frSelecionarPartidos
     */
    public frSelecionarPartidos() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frSelecionarPartidos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frSelecionarPartidos().setVisible(true);
            }
        });
    }
