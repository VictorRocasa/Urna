 ...
 * @author victorPC
 */
public class frSelecionarCandidatos extends javax.swing.JFrame {

    /**
     * Creates new form frSelecionarCandidatos
     */
    public frSelecionarCandidatos() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frSelecionarCandidatos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frSelecionarCandidatos().setVisible(true);
            }
        });
    }
